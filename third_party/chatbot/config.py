...
class TextToImage(BaseModel):
    ...
    width: int = 700
    """生成图片宽度"""
    font_path: str = "../../../qqbot/chatgpt-mirai-qq-bot-browser-version/fonts/sarasa-mono-sc-regular.ttf"
    """字体路径"""
    offset_x: int = 50
    """横坐标"""
    offset_y: int = 50
...
class Preset(BaseModel):
    ...
    scan_dir: str = "../../../qqbot/chatgpt-mirai-qq-bot-browser-version/presets"
