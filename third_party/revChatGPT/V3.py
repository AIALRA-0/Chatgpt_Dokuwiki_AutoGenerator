...
class Chatbot:
    ...
    def ask_stream(self, prompt: str, role: str = "user", **kwargs) -> str:
        ...
        if "gpt-3.5-turbo" in self.engine:
            endpoint = "https://api.openai.com/v1/chat/completions"
        elif "edit" in self.engine:
            endpoint = "https://api.openai.com/v1/edits"
        elif "text-davinci" in self.engine:
            endpoint = "https://api.openai.com/v1/completions"
        elif "code-davinci" in self.engine:
            endpoint = "https://api.openai.com/v1/edits"
        elif "whisper" in self.engine:
            endpoint = "https://api.openai.com/v1/audio/transcriptions"
        elif "text-curie" in self.engine:
            endpoint = "https://api.openai.com/v1/completions"
        elif "text-babbage" in self.engine:
            endpoint = "https://api.openai.com/v1/completions"
        elif "text-ada" in self.engine:
            endpoint = "https://api.openai.com/v1/completions"
        elif "text-embedding" in self.engine:
            endpoint = "https://api.openai.com/v1/embeddings"
        elif "text-search" in self.engine:
            endpoint = "https://api.openai.com/v1/embeddings"
        elif "text-moderation" in self.engine:
